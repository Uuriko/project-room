...
optional.push("src/room-mcp-join.js", "src/share-invite-code.js", "server/mcp-http.mjs");
...
optional.push("server/oauth-state-seal.mjs"); // Stateless OAuth state seal (imported by server/google-oauth.mjs and server/github-oauth.mjs)
