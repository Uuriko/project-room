...
let payload = readFileSync(join(dir, ".browser-check.b64"), "utf8").trim();
const fixPath = join(dir, ".browser-check.b64.fix");
...
const dest = join(dir, ".browser-check." + digest + ".generated.mjs");
