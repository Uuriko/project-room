...
const payload = readFileSync(join(dir, ".reconnect-collaboration-browser-check.b64"), "utf8");
const digest = createHash("sha256").update(payload).digest("hex").slice(0, 16);
const dest = join(dir, ".reconnect-collaboration-browser-check." + digest + ".generated.mjs");
