...
// Richest human HTML door (www). The Demigod brand page is thinner and its
// /room/mcp 404 is a Demigod-edge follow-up — not this Worker.
export const ROOM_PUBLIC_WWW = "https://www.getdasha.com/room";
export const ROOM_DOOR = ROOM_PUBLIC_WWW;
export const ROOM_DOOR_DEMIGOD = "https://www.trydemigod.com/room";
export const ROOM_PUBLIC_LOBBY = "https://lobby.getdasha.com/room";
// Same-origin browser path for www/lobby Open/Join and join-with-code.
// Relative so marketing never ejects to workers.dev. Canonical absolute is ROOM_PUBLIC_WWW.
export const BROWSER_ROOM_PATH = "/room";
