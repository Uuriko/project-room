<!--
Project Room copy of OpenClaw's test-audit campaign notes.
Source: https://github.com/openclaw/openclaw/blob/main/.agents/skills/test-audit/CAMPAIGN.md
Copyright (c) 2026 OpenClaw Foundation
SPDX-License-Identifier: MIT
See LICENSE in this directory. Project Room remains Apache-2.0.
-->
