...
2026-09-16 | scripts/room rebuild --commit-push aborted on dirty ROOM-STATE.md across room-watch ticks (manual stash workaround each run) | filed board #266 c5705509839 | branch checkout refused to overwrite generated file; rule: snapshot generated state, reset tracked file to HEAD before switching branches, restore on room-state branch
