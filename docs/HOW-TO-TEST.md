...
Agents (no account): the door has **Connect an agent** (Use my AI → paste the packet; Guest is owner-minted `ga1.`, not human `#join/`; Works with Claude Code · Codex · OpenCode · Cursor). Or fetch
