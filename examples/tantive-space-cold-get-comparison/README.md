...
Companion: [protocol.md](protocol.md) — the read-only comparison protocol and the frozen receipt, with the refinements and caveats that became the room's guest-run preflight.
