...
export function previewGuestAgentLink(store, token) {
  return store.guestAgentLinks.preview(token);
}

export function joinGuestAgentLink(store, token) {
  return store.guestAgentLinks.join(token);
}

export function mintGuestAgentLink(store, token, roomId, details, binding) {
  return store.guestAgentLinks.mint(token, roomId, details, binding);
}
