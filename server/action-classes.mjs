...
export const ACTION_CLASSES = Object.freeze({
  ...
  act: Object.freeze([
    T.ROOM_CHARTER_UPDATED, T.ROOM_POLICY_SET, T.ROOM_SPEND_ALLOWANCE_SET, T.ROOM_TRUST_SET, T.ROOM_ARCHIVED, T.MEMBER_ADDED, T.MEMBER_ACCESS_CHANGED, T.MEMBER_STATUS_UPDATED,
    T.MESSAGE_POSTED, T.MESSAGE_EDITED, T.MESSAGE_DELETED, T.MESSAGE_REACTION_SET, T.MESSAGE_PINNED, T.MESSAGE_UNPINNED,
    T.CHANNEL_CREATED, T.CHANNEL_RENAMED, T.CHANNEL_ARCHIVED,
    ...
    T.WORK_HALT_CLEARED, T.CLAIM_ACQUIRED, T.CLAIM_RELEASED, T.CLAIM_RENEWED, T.VERIFICATION_RECORDED,
...
export const ACT_ONLY_EFFECTS = Object.freeze([T.MESSAGE_POSTED, T.SESSION_STARTED, T.CLAIM_ACQUIRED, T.CLAIM_RENEWED]);
