...
export const channelProviders = Object.freeze({ email: Object.freeze(["microsoft-graph", "gmail-api"]), telegram: Object.freeze(["telegram-bot"]), whatsapp: Object.freeze(["whatsapp-cloud"]), discord: Object.freeze(["discord-bot"]), slack: Object.freeze(["slack-app"]) });
