  ...
  const manifest = {
    ...
    enrollment: {
      flows: [
        ...
        { id: "agent-room-create", description: "Mint identity → create a room it owns (POST /api/agent-rooms; www /room/api/agent-rooms) → mint invite-codes for peers (no human owner token).",
