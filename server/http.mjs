    ...
    try {
      ...
      if (url.pathname === "/api/inbox" || url.pathname.startsWith("/api/inbox/")) {
        ...
        if (replySource && req.method === "GET") {
          if (!["reply-review-v1", "reply-review-v2", "reply-review-v3"].includes(view) || [...url.searchParams.keys()].length !== 1) reject(422, "unsupported_inbox_view", "Choose the supported reply review.");
