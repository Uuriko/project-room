...
test("exact-commit runtime package verifies cold, excludes private state and preserves populated committed-schema data", async t => {
  ...
  assert.equal(receipt.files, 47 + ["server/inbox-stitch.mjs", "server/inbox-stitch-store.mjs", "server/inbox-spam.mjs", "server/notify-prefs.mjs", "server/inbox-import-guards.mjs", "server/spam-shadow.mjs", "src/inbox-client.js", "src/inbox-ui.js", "src/inbox-send-ui.js", "server/maintenance.mjs", "server/recovery.mjs", "client/agent-connection.mjs", "server/agent-connections.mjs", "server/agent-identities.mjs", "server/agent-invites.mjs", "src/agent-connections.js", "src/agent-error.mjs", "client/mcp-stdio.mjs", "scripts/agent-mcp.mjs", "client/work-actions.mjs", "server/work-discussion.mjs", "server/text-results.mjs", "client/attention-inbox.mjs", "src/room-charter.js", "src/room-instructions.js", "src/reply-requests.js", "server/reply-requests.mjs", "client/reply-actions.mjs", "scripts/agent-replies.mjs", "scripts/agent-doctor.mjs", "client/request-notices.mjs", "src/work-help.js", "server/work-help.mjs", "src/help-offers.js", "client/help-actions.mjs", "server/inbox.mjs", "server/inbox-outbox.mjs", "server/inbox-transport.mjs", "server/email-envelope.mjs", "server/graph-email.mjs", "server/email-import.mjs", "server/graph-fixture-sync.mjs", "server/graph-reply-draft.mjs", "server/graph-reply-journal.mjs", "server/graph-reply-update-review.mjs", "server/version.mjs", "scripts/stamp-version.mjs", "src/room-roster.js", "src/account-settings-ui.js", "src/auth-signin-ui.js", "src/invite-context.js", "deploy/agent-discovery.mjs", "deploy/room-entry.mjs", "server/guest-agent-links.mjs", "src/work-item-session.js", "src/work-loops.js", "src/work-recipes.js", "src/board.js", "src/work-templates.js", "src/room-templates.js", "server/diagnostics.mjs", "scripts/release-evidence.mjs", "server/action-classes.mjs", "server/wake-queue.mjs", "server/attention.mjs", "server/moderation.mjs", "server/channel-connection.mjs", "server/channel-import.mjs", "server/channel-adapters/index.mjs", "server/channel-adapters/email.mjs", "server/channel-adapters/telegram.mjs", "server/channel-adapters/telegram-rotation.mjs", "server/channel-adapters/gmail.mjs", "server/channel-adapters/whatsapp.mjs", "server/mime-message.mjs", "server/email-routing-inbound.mjs", "server/channel-journal.mjs", "server/spam-quarantine-journal.mjs", "server/quarantine-thread-splits.mjs", "src/inbox-quarantine-ui.js", "server/channel-drain.mjs", "server/sla-clocks.mjs", "server/sla-urgent-notify.mjs", "server/sla-sweep.mjs", "server/sla-sweep-hooks.mjs", "server/sla-breach-journal.mjs", "server/morning-digest.mjs", "server/digest-mode.mjs", "server/inbox-triage.mjs", "server/inbox-handoff.mjs", "server/channel-adapters/telegram-config.mjs", "server/channel-adapters/telegram-transport.mjs", "scripts/telegram-set-webhook.mjs", "scripts/telegram-rotate-webhook.mjs", "server/boot-options.mjs", "server/instance-lock.mjs", "server/room-export-html.mjs", "server/access-review.mjs", "server/usage-summary.mjs", "server/notifications.mjs", "server/spend-allowance.mjs", "server/pins.mjs", "server/room-lifecycle.mjs", "server/attachment-schema.mjs", "server/access-requests.mjs", "server/identity-ratelimit.mjs", "server/agent-rooms.mjs", "server/google-oauth.mjs", "server/github-oauth.mjs", "server/inbox-search.mjs", "server/inbox-threads.mjs", "src/growth-emit.js", "src/growth-events.js", "src/growth-collector.js", "src/growth-mentions.js", "src/growth-fanout.js", "src/growth-persistence.js", "src/growth-summary.js", "src/growth-compare.js", "src/growth-alerts.js", "src/growth-watch.js", "src/growth-scheduler.js", "src/growth-http.js", "src/growth-digest.js", "server/account-login-methods.mjs", "server/account-passkeys.mjs", "src/passkey-login.mjs", "src/password-auth.mjs", "server/magic-links.mjs", "server/channel-adapters/messenger.mjs", "server/channel-adapters/sms.mjs", "server/messenger-ingest.mjs", "server/messenger-outbound.mjs", "server/sms-ingest.mjs", "server/sms-outbound.mjs", "server/quarantine-review-coverage.mjs", "server/agent-api-keys.mjs", "server/agent-directory.mjs", "server/agent-plugin-manifest.mjs", "server/outbound-webhooks.mjs", "server/agent-webhook-subscriptions.mjs", "server/agent-plugin-store.mjs", "server/agent-plugin-routes.mjs", "server/inbox-assign.mjs", "server/inbox-internal-notes.mjs", "server/inbox-collision.mjs", "server/inbox-approval.mjs", "server/inbox-agent-routing.mjs", "server/inbox-collab-store.mjs", "server/inbox-collab-routes.mjs"].filter(path => existsSync(join(destination, path))).length);  assert.equal(existsSync(join(destination, ".git")), false);
...
test("uncommitted candidate packages cold in an isolated synthetic commit, including request observer dependencies", t => {
  ...
  const receipt = createRuntimePackage({ ...candidate, destination }); assert.equal(receipt.files, 197); // +2 SLA hook files +2 quarantine review files +1 shadow instrumentation +6 sms/messenger channel files +1 quarantine-review-coverage +7 Lane D agent plug-in modules +5 Lane C collab pure modules +2 Lane C collab store/routes (RC-2026-09-18-011) +2 webhook rotation files
  const program = `
