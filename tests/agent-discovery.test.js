...
test("edge door predicate: getdasha /room only, prefix preserved", () => {
  ...
  for (const host of EDGE_DOOR_HOSTS) {
    for (const path of ["/room", "/room/", "/room/llms.txt", "/room/llms-full.txt", "/room/.well-known/agent.json", "/room/skill.md", "/room/skill", "/room/agent.json", "/room/health", "/room/kits", "/room/apps", "/room/tools", "/room/api/agent-rooms", "/room/api/agent-identities", "/room/api/identity-create", "/room/api/agent-invites/redeem"]) {
