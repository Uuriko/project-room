...
for (const [version, baseline] of [[8, v8ConnectionBaseline], [9, v9TextBaseline], [10, v10CharterBaseline], [11, v11ReplyBaseline], [12, v12HelpBaseline], [13, v13OfferBaseline], [14, v14InboxBaseline], [15, v15AdoptionBaseline], [16, v16SendBaseline], [17, v17EmailBaseline], [18, v18EmailSourceBaseline], [19, v19EmailExcerptBaseline], [20, v20ReplyJournalBaseline], [21, v21ReplyReviewBaseline], [22, v22ReplyUpdateBaseline], [23, v23ReplyAcknowledgmentBaseline], [24, v24ReplyResolutionBaseline], [25, "33c817a911ebb9fb0310592cac77d8e61380541d"], [26, v26IdentitiesBaseline], [27, "b1ec4f0c0b72f2a6967acdec33345ae713c1b53e"], [28, "37f5e4d08758fac857ef5298f5c656efd98f000f"], [29, "a008732e5a514699bd07114ffb8cf5f53047f0cd"], [30, "6ebf919000da8741b17c6491327e9bf7bf791978"], [31, "0e3f824471b5e69f93a8e325a8c490d02c81029f"], [32, "51564ad22681569753d0479cebe12f798d9352ec"]]) test(`genuine v${version} data upgrades atomically; old writers cannot write v33`, async t => {
  ...
  assert.equal(observedVersion, 33, "fault was injected after installing the new writer");
  ...
  assert.throws(() => cached.run(f.owner.session.account.id), /project_room_writer_v33|unsupported database writer/);
  assert.throws(() => new OldStore(f.filename), /newer than this service/);
  current.createAccount("after-v31-upgrade");
  assert.equal(current.account("after-v31-upgrade").active, true);
